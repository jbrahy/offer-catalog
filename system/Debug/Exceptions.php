...
class Exceptions {
	...
	protected function collectVars(Throwable $exception, int $statusCode): array
	{
		...
		return [
			'title' => get_class($exception), 'type' => get_class($exception), 'code' => $statusCode, 'message' => $exception->getMessage() ?? '(null)', 'file' => $exception->getFile(), 'line' => $exception->getLine(), 'trace' => $trace,
		];
	}
