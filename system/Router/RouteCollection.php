...
class RouteCollection implements RouteCollectionInterface {
	 ...
	 *      GET         /photos/new         new             showing a form for an empty photo object, with default
	 *      properties POST        /photos/create      create          processing the form for a new photo GET
	 *      /photos/edit/{id}   edit            show an editing form for a specific photo object, editable properties
	 *      POST        /photos/update/{id} update          process the editing form data GET
	 *      /photos/remove/{id} remove          show a form to confirm deletion of a specific photo object POST
	 *      /photos/delete/{id} delete          deleting the specified photo object
	 *
