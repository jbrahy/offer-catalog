...
class FeatureTestCase extends CIUnitTestCase {
	...
	protected function populateGlobals(string $method, Request $request, array $params = NULL)
	{
		...
		$get = ! empty($params) && $method === 'get' ? $params : $this->getPrivateProperty($request->uri, 'query'); // @phpstan-ignore-line
	 ...
	 *
	 * @param Request $request
	 * @param null|array $params The parameters to be formatted and put in the body. If this is empty, it will get
	 *                               the what has been loaded into the request global of the request class.
	 *
	 * @return Request
	 */
