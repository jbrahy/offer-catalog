...
class Query implements QueryInterface {
	...
	public function debugToolbarDisplay(): string
	{
		...
		static $highlight = [
			'SELECT', 'DISTINCT', 'FROM', 'WHERE', 'AND', 'LEFT&nbsp;JOIN', 'RIGHT&nbsp;JOIN', 'JOIN', 'ORDER&nbsp;BY', 'GROUP&nbsp;BY', 'LIMIT', 'INSERT', 'INTO', 'VALUES', 'UPDATE', 'OR&nbsp;', 'HAVING', 'OFFSET', 'NOT&nbsp;IN', 'IN', 'LIKE', 'NOT&nbsp;LIKE', 'COUNT', 'MAX', 'MIN', 'ON', 'AS', 'AVG', 'SUM', '(', ')',
		];
	...
	protected function compileBinds()
	{
		...
		if (empty($this->binds) || empty($this->bindMarker) || ( ! $hasNamedBinds && strpos($sql, $this->bindMarker) === FALSE))
		{
			return;
		}
