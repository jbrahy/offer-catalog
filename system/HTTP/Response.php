...
class Response extends Message implements MessageInterface, ResponseInterface {
	...
	public function __construct($config)
	{
		...
		Cookie::setDefaults(config('Cookie') ?? [
				...
				'prefix' => $config->cookiePrefix, 'path' => $config->cookiePath, 'domain' => $config->cookieDomain, 'secure' => $config->cookieSecure, 'httponly' => $config->cookieHTTPOnly, 'samesite' => $config->cookieSameSite ?? Cookie::SAMESITE_LAX,
			]);
