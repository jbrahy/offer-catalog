...
class IncomingRequest extends Request {
	...
	{
		return $this->hasHeader('X-Requested-With') && strtolower($this->header('X-Requested-With')
				->getValue()) === 'xmlhttprequest';
	}
	...
	public function isSecure(): bool
	{
		...
		return $this->hasHeader('Front-End-Https') && ! empty($this->header('Front-End-Https')
				->getValue()) && strtolower($this->header('Front-End-Https')->getValue()) !== 'off';
	}
	 ...
	 *
	 * @param string $index The variable that you want which can use dot syntax for getting specific
	 *                                   values.
