...
class CLI {
	 ...
	 * @param string|array $options String to a default value, array to a list of options (the first option will be
	 *                                 the default value)
	...
	public static function clearScreen()
	{
		...
		static::isWindows() && ! static::streamSupports('sapi_windows_vt100_support', STDOUT) ? static::newLine(40) : static::fwrite(STDOUT, "\033[H\033[2J");
	}
