...
if ( ! function_exists('set_cookie'))
{
	 ...
	 */
	function set_cookie($name, string $value = '', string $expire = '', string $domain = '', string $path = '/', string $prefix = '', bool $secure = FALSE, bool $httpOnly = FALSE, string $sameSite = NULL)
	{
