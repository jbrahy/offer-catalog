...
if ( ! function_exists('form_input'))
{
	...
	{
		$defaults = [
			'type' => $type, 'name' => is_array($data) ? '' : $data, 'value' => $value,
		];
...
if ( ! function_exists('form_textarea'))
{
	...
	{
		$defaults = [
			'name' => is_array($data) ? '' : $data, 'cols' => '40', 'rows' => '10',
		];
...
if ( ! function_exists('form_checkbox'))
{
	...
	{
		$defaults = [
			'type' => 'checkbox', 'name' => (! is_array($data) ? $data : ''), 'value' => $value,
		];
...
if ( ! function_exists('form_button'))
{
	...
	{
		$defaults = [
			'name' => is_array($data) ? '' : $data, 'type' => 'button',
		];
...
if ( ! function_exists('form_datalist'))
{
	...
	{
		$data = [
			'type' => 'text', 'name' => $name, 'list' => $name . '_list', 'value' => $value,
		];
