...
abstract class BaseModel {
	...
	public function find($id = NULL)
	{
		...
		if ($this->tempAllowCallbacks)
		{
			...
			$eventData = $this->trigger('beforeFind', [
				'id' => $id, 'method' => 'find', 'singleton' => $singleton,
			]);
		...
		$eventData = [
			'id' => $id, 'data' => $this->doFind($singleton, $id), 'method' => 'find', 'singleton' => $singleton,
		];
	...
	public function first()
	{
		...
		$eventData = [
			'data' => $this->doFirst(), 'method' => 'first', 'singleton' => TRUE,
		];
	...
	public function update($id = NULL, $data = NULL): bool
	{
		...
		$eventData = [
			'id' => $id, 'data' => $eventData['data'], 'result' => $this->doUpdate($id, $eventData['data']),
		];
	...
	public function insert($data = NULL, bool $returnID = TRUE)
	{
		...
		$eventData = [
			'id' => $this->insertID, 'data' => $eventData['data'], 'result' => $result,
		];
	...
	public function delete($id = NULL, bool $purge = FALSE)
	{
		...
		$eventData = [
			'id' => $id, 'data' => NULL, 'purge' => $purge, 'result' => $this->doDelete($id, $purge),
		];
	...
	public function findAll(int $limit = 0, int $offset = 0)
	{
		if ($this->tempAllowCallbacks)
		{
			// Call the before event and check for a return
			$eventData = $this->trigger('beforeFind', [
				'method' => 'findAll', 'limit' => $limit, 'offset' => $offset, 'singleton' => FALSE,
			]);
		...
		$eventData = [
			'data' => $this->doFindAll($limit, $offset), 'limit' => $limit, 'offset' => $offset, 'method' => 'findAll', 'singleton' => FALSE,
		];
