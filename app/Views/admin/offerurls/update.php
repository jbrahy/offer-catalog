            ...
            <div class="row ">
                <div class="col-xs-12 col-sm-12 col-md-8 offset-md-2">       
                    ...
                    <form role="form" name="newOfferUrlForm" id="newOfferUrlForm"
                          action="<?php
                          echo base_url(); ?>/admin/offerurls/save-update" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="offer_url" name="offer_url" value="<?php echo $offer_url_detail->offer_url;?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" id="offer_url_type_id" name="offer_url_type_id" required>
                                ...
                                <?php 
                                    ...
                                    {
                                ?>
                                <option value="<?php echo $url_type->offer_url_type_id;?>" <?php if ( $offer_url_detail->offer_url_type_id == $url_type->offer_url_type_id ) {?>selected="selected" <?php } ?>><?php echo $url_type->offer_url_type;?></option>
                                <?php 
                                    }
                                ?>    
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="ckeditor form-control" id="editor1" name="offer_url_description"  rows="5" required ><?php echo $offer_url_detail->offer_url_description;?></textarea>
                        </div>
                        ...
                        <input type="hidden" name="offer_url_id" value="<?php echo $offer_url_id;?>" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#brand_id').change(function () {
                ...
                window.location = '<?php echo base_url();?>/admin/offerurls/edit/'+brandId+'/<?php echo $offer_url_id;?>';
