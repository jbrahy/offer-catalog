            ...
            <div class="row ">
                <div class="col-xs-12 col-sm-12 col-md-8 offset-md-2"> 
                    ...
                    <form role="form" name="newOfferForm" id="newOfferForm"
                        ...
                        <div class="form-group">
                            <label for="offer_url_type_id">Offer URL Type:</label>
                            <select class="form-select" id="offer_url_type_id" name="offer_url_type_id" required>
                                <option value="">-- Select Status --</option>
                                <?php 
                                foreach($result_offer_url_types as $r)
                                {
                                ?>
                                <option value="<?php echo $r->offer_url_type_id;?>"><?php echo $r->offer_url_type;?></option>
                                <?php 
                                }
                                ?>
